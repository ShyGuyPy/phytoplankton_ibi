...
The subsequent use of the `dir.creat` structure ensures that the proper directory structure is in place when pulling data using the API.
```{r}
...
```{r}
phyto.df <- data.table::fread(file.path(project.dir, "data/CEDR/", "cedr_phyto_taxa.csv")) %>% 

...
wq.df <- file.path(url.root,
                   ...
                   "6",  #programIds...2, 4 and/or 6
                   "7,16,23,24",  #projectIds
                   "station",
                   paste(station.vec, collapse = ","),
                   paste(chla,doc,pheo,salinity, sep=",")) %>%
...
COMPARE STEP 4
note: 3480 to 3481 in Claire's excel
```{r}
...
COMPARE STEP 6 (Claire's is 3360)
```{r}
...
COMPARE STEP 7 (Claire's is 2024)
```{r}

...
```{r}
hier.wide_test <- hier.wide[, column.vec]
```
...
# 
# itis_compare.df <- anti_join(itis_old.df,itis_new.df, by = c("final_id", "tsn")) 
# itis_also_compare.df <- anti_join(itis_new.df,itis_old.df, by = c("final_id", "tsn")) 
```

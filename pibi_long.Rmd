...
test_score_spring_f <- metrics_prep.df %>% 
  filter(
           season == "spring",
           salzone == "f"#,
...
```{r}
test_score_spring_o <- metrics_prep.df %>% 
  filter(
           season == "spring",
           salzone == "o"#,
...
```{r}
test_score_spring_m <- metrics_prep.df %>% 
  filter(
           season == "spring",
           salzone == "m"#,
...
```{r}
test_score_spring_p <- metrics_prep.df %>% 
  filter(
           season == "spring",
           salzone == "p"#,
...
```{r}
test_score_summer_f <- metrics_prep.df %>% 
  filter(
           season == "summer",
           salzone == "f"#,
...
```{r}
test_score_summer_o <- metrics_prep.df %>% 
  filter(
           season == "summer",
           salzone == "o"#,
...
```{r}
test_score_summer_m <- metrics_prep.df %>% 
  filter(
           season == "summer",
           salzone == "m"#,
...
```{r}
test_score_summer_p <- metrics_prep.df %>% 
  filter(
           season == "summer",
           salzone == "p"#,
